...
public class InputAction
{
	...
	///	</param>
	/// <returns>
	///		<see langword="true"/> if <paramref name="source"/> was successfully bound; <see langword="false"/> if it
	///		was already present.
	///	</returns>
	...
	///	</param>
	/// <returns>
	///		<see langword="true"/> if the <paramref name="source"/> was successfully unbound; <see langword="false"/>
