...
public interface IPlayerInputManager
{
	...
	///	</param>
	/// <returns>
	///		<see langword="true"/> if the <paramref name="playerIndex"/> is defined; otherwise,
	///		<see langword="false"/>.
	///	</returns>
	...
	/// </param>
	/// <param name="player">
	///		When this method returns, contains the player assigned to the specified player index, if the player index
	///		is defined; otherwise, <see langword="null"/>.
	///	</param>
	/// <returns>
