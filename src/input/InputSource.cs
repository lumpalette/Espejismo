...
/// extend this class directly; use <see cref="InputSource{TSource}"/> instead, which provides strongly-typed equality
...
public abstract class InputSource<TSource> : InputSource, IEquatable<TSource> where TSource : InputSource<TSource>
{
	...
	/// </param>
	/// <returns>
	/// <see langword="true"/> if <paramref name="other"/> is a <typeparamref name="TSource"/> and is equal; otherwise,
	/// <see langword="false"/>.
	/// </returns>
