...
/// </summary>
/// <remarks>
///		The main purpose of this class is to provide a homogeneous interface for any type of input source. Do
///		<b>not</b> extend this class directly; use <see cref="InputSource{TSource}"/> instead, which provides
///		strongly-typed equality handling automatically.
/// </remarks>
public abstract class InputSource : IEquatable<InputSource>
{
	...
	///	</param>
	/// <param name="value">
	///		When this method returns, contains a value in the range [-1,1] representing the strength of the event, if
	///		it matches; otherwise, 0.0.
	///	</param>
	/// <returns>
