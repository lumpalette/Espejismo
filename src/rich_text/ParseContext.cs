...
public class ParseContext
{
	...
	/// </remarks>
	public ReadOnlySpan<InlineCommand> Commands => CollectionsMarshal.AsSpan(_commands);
	...
	/// <summary>
	/// Creates and appends a new <see cref="TextRun"/> with the specified text and the current <see cref="TopStyle"/>.
	/// </summary>
	/// <param name="text">
	...
	/// <summary>
	/// Creates a new <see cref="InlineCommand"/> with the specified name and properties and inserts it at the current
	/// text position.
	/// </summary>
	/// <param name="name">
	...
	public void AppendCommand(string name, ReadOnlySpan<TagProperty> properties)
	{
		...
		_commands.Add(new InlineCommand(name, _textPosition, properties.ToArray()));
	}
