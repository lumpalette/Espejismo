...
public abstract class TextTag(string name, IReadOnlyList<string> requiredProperties)
{
	...
	/// <summary>
	/// 	Gets the names of the properties required for the tag to properly function.
	/// </summary>
	/// <remarks>
	...
	///	</param>
	/// <returns>
	///		The matching <see cref="TagProperty"/> if found; otherwise, the <see langword="default"/> value for the
	///		type.
	///	</returns>
